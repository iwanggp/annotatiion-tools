...
void ClassWindow::createActions()
{
    ...
    connect(_drawAct, &QAction::toggled, this, &ClassWindow::drawBoxItem);
...
//    connect(_zoomOutAct, &QAction::triggered, this, &MainWindow::zoomOut);
    ...
    _exportVOC = new QAction(QIcon(":/images/export.png"), tr("&Export Image"), this);
...
void ClassWindow::drawBoxItem(bool checked)
{
    if (!_isImageLoaded)
        return;
...
void ClassWindow::updateCopyCutActions()
{
...
void ClassWindow::updatePasteAction()
{
...
void ClassWindow::updateBoxInfo(QRect rect, QString typeName)
{
...
void ClassWindow::updateLabelCursorPos(QPointF cursorPos)
{
