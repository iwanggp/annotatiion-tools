...
QStringList MainWindow::loadTypeNameFromFile(QString filePath)//加载下拉框
{
...
void MainWindow::createActions()
{
    ...
    //go back
    _goHome = new QAction(QIcon(":/images/quit.png"), tr("&Go Home..."), this);
    _goHome->setShortcuts(QKeySequence::Back);
    _goHome->setStatusTip(tr("Go Home"));
    connect(_goHome, &QAction::triggered, this, &MainWindow::goHome);
...
//    connect(_drawAct, &QAction::toggled, this, &MainWindow::drawBoxItem);
    ...
    connect(_prevAct, &QAction::triggered, this, &MainWindow::prevImage);
    ...
    connect(_nextAct, &QAction::triggered, this, &MainWindow::nextImage);
